# -*- coding: utf-8 -*-
"""
Created on Fri Nov  8 18:44:25 2019
...
def play_move(state, player, block_num):
    if state[int((block_num-1)/3)][(block_num-1)%3] == ' ':
        ...
        block_num = int(input("Block is not empty, ya idiot Choose again: "))
...
## PLaying
state_values_for_AI = np.loadtxt('C:\\Users\\P70002567\\Desktop\\Tic Tac Toe\\trained_state_values_X.txt', dtype=np.float64)
